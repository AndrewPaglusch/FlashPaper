				...
				<fieldset>
					<div>
						...
						<div style="font-style: italic">
							<label style="font-family: 'Proxima Nova', arial, serif; color:#fafafa; line-height: 1.25; margin: 0 0 10px; font-size: 15px; font-weight: bold;"><?php echo $settings['messages']['view_secret_subheader'] ?></label>
						</div>
