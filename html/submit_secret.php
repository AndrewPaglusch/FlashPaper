		...
		<div class="centered-div">
			<div id="form-div">
				<form class="form-horizontal" action="" method="POST">
					<fieldset>
						<div>
							<label class="main-label" style="font-family: 'Proxima Nova', arial, serif; color:#fafafa; line-height: 1.25; margin: 0 0 10px; font-size: 30px; font-weight: bold;"><?php echo $settings['messages']['submit_secret_header']; ?></label>
						...
						<div style="margin-bottom:10px;">
							<div class="centered-div center-slider">
								...
								<input type="range" min="1" max="365" value="50" class="slider" name="expire-days" id="expire-days" oninput="this.nextElementSibling.value = this.value">
